...
# create json_file
with open("{}/categories.json".format(file_path), "w", encoding='utf-8') as file:
    file.write(html_cat)
with open("{}/hotel_1.json".format(file_path), "w", encoding='utf-8') as file:
    file.write(html_comp)
with open("{}/reviews_1.json".format(file_path), "w", encoding='utf-8') as file:
    file.write(html_rev)